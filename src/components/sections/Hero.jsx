...
export const Hero = () => (
  <section className="relative min-h-screen flex items-center overflow-hidden bg-[#0a1340]">
    {/* Gradient background */}
      ...
      <div className="max-w-3xl">
        ...
        <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-2 mb-8">
          ...
          <span className="text-sm text-white/80 font-medium">
            N°1 de l'assurance emprunteur en France
          </span>
        </div>
        ...
        <p className="text-xl text-white/60 leading-relaxed mb-10 max-w-2xl">
          Comparez en 2 minutes les meilleures offres du marché et économisez
          des milliers d'euros sur la durée de votre prêt immobilier.
        </p>
    ...
    <div className="hidden lg:block absolute right-16 bottom-24 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-5 max-w-xs">
      ...
      <p className="text-white/70 text-sm leading-relaxed">
        "Économisé <strong className="text-white">8 400€</strong> sur mon prêt. Service impeccable et rapide !"
      </p>
    </div>
  </section>
)
