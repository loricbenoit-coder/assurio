...
const FAQ_ITEMS = [
  {
    ...
    answer:
      "Oui. Depuis la loi Lemoine de 2022, vous pouvez résilier et changer d'assurance emprunteur à tout moment, sans frais ni pénalité, quelle que soit la date de signature de votre prêt.",
  },
  {
    question: 'Ma banque peut-elle refuser ma nouvelle assurance ?',
    answer:
      "Votre banque est obligée d'accepter votre nouvelle assurance si elle présente des garanties au moins équivalentes. Nous vérifions systématiquement l'équivalence des garanties avant toute souscription.",
  },
  {
    question: "Combien de temps prend le changement d'assurance ?",
    answer:
      "En moyenne, le délai total est de 10 à 20 jours. Nous nous occupons de tout : la constitution du dossier, la communication avec votre banque et le suivi jusqu'à la résiliation effective.",
  },
  {
...
const FAQItem = ({ question, answer }) => {
  ...
  return (
    <div className="border-b border-slate-100 last:border-0">
      ...
      >
        <span className="font-medium text-[#0a1340] group-hover:text-[#0f1f6b] transition-colors pr-4">
          {question}
        </span>
        <ChevronDown
          className={cn(
  ...
  <section id="faq" className="py-24 bg-slate-50">
    <div className="max-w-3xl mx-auto px-6">
      <div className="text-center mb-14">
        ...
        <h2 className="text-4xl md:text-5xl font-bold text-[#0a1340] tracking-tight">
