...
export const useHeroContent = () => ({
  ...
  highlight: "-60%",
  subtitle: "Comparez en 2 minutes les meilleures offres du marché et économisez des milliers d'euros sur la durée de votre prêt immobilier.",
  ctaPrimary: "Comparer maintenant",
